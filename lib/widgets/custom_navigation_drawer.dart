     ...
     child: Drawer(
       child: Column(
         children: [
               ...
               child: Column(
                 children: [
                   ...
                   CustomText(
                     ...
                     text: 'Name xyz',color: AppColors.primary,weight: FontWeight.w700,),
                   const Expanded(
                       child: CustomText(
                           textAlign: TextAlign.center,
           ...
           drawerWidget(Icons.person, 'Admin Login/Profile'),
           drawerWidget(Icons.event, 'Add Event'),
           drawerWidget(Icons.mail_outline, 'Chat Box'),
           drawerWidget(Icons.group, 'Manage Volunteer'),
           InkWell(
               onTap: () async {
      ...
      child: GestureDetector(
        ...
        child: Column(
          children: [
            ...
            Divider(color: AppColors.primary.withOpacity(0.07),thickness: 2,)
          ],
        ),
      ),
    );
